var Funcionario = /** @class */ (function () {
    ...
    Funcionario.prototype.setSalarioBruto = function (salarioBruto) {
        this.funcionario.salarioBruto = salarioBruto;
    };
    Funcionario.prototype.setTotalHoraExtra = function (totalHoraExtra) {
        this.funcionario.totalHoraExtra = totalHoraExtra;
    };
    Funcionario.prototype.somaVencimentos = function () {
        return this.funcionario.salarioBruto + this.funcionario.totalHoraExtra;
    };
    Funcionario.prototype.descontaValorDoINSS = function (valorVencimentos) {
    ...
    Funcionario.prototype.descontaIR = function (salario) {
        if (salario <= 1903.98) {
    ...
    Funcionario.prototype.calculaSalarioLiquido = function (valorVencimentos, valorDescontadoINSS, valorDescontadoIR, totalHoraExtra) {
...
function main(nome, salarioBruto, totalHoraExtra) {
    ...
    var somaVencimentos = funcionario.somaVencimentos();
    ...
    console.log("Cálculo do Salário Líquido: " +
        funcionario.calculaSalarioLiquido(somaVencimentos, funcionario.funcionario.valorDescontadoINSS, funcionario.funcionario.valorDescontadoIR, funcionario.funcionario.totalHoraExtra));
